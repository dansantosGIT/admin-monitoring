...
<head>
  ...
  <style>
    ...
    input[type=email],input[type=password]{width:100%;height:44px;padding:10px 12px;border-radius:12px;border:1px solid rgba(0,0,0,0.12);font-size:14px;outline:none;box-sizing:border-box}
    ...
    .forgot{float:right;font-size:13px;color:var(--muted);text-decoration:none}
...
<body>
  ...
  <main class="page">
    ...
    <section class="card" role="form" aria-labelledby="login-heading">
      ...
      <form method="POST" action="{{ route('login') }}" novalidate>
        ...
        <label class="label">Password <a href="{{ route('password.request') }}" class="forgot">Forgot ?</a>
        ...
        <div class="muted">Accounts require superadmin approval before access.</div>
        ...
        <p class="muted small">Don't have an account? <a href="{{ route('register') }}">Register</a></p>
      </form>
    </section>
  </main>
